// netlify/functions/check-overdue-invoices.js
...
exports.handler = async () => {
  try {
    // Računi čiji je rok plaćanja bio juče (upravo postali overdue)
    ...
    // Grupiši po majstor_id (jedan push po majstoru)
    const majstorMap = {}
    ...
    for (const [majstorId, invoices] of Object.entries(majstorMap)) {
      ...
      // Dohvati subscriptions za ovog majstora
