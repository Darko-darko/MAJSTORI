// lib/supabase.js - OPTIMIZED: No Supabase Attack Protection, only Turnstile on signup/forgot
...
export const auth = {
  // Sign up new user (Turnstile will be on frontend)
  ...
  // Sign in existing user (NO CAPTCHA - better UX)
  ...
  // Request password reset email (Turnstile will be on frontend)
