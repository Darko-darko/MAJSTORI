...
export function useSubscription(majstorId) {
 ...
 try {
 console.log(' Handling expired subscription for user:', majstorId)
 ...
 console.log(' Ignoring redundant expired status update (prevents loop)')
 return
 }
 ...
 // oldCancelFlag moe biti true ili undefined (ako webhook ne alje old values)
