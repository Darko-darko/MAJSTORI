// lib/hooks/useSubscription.js - SA EVENT LISTENER
...
export function useSubscription(majstorId) {
  ...
  // 🔥 NOVI LISTENER ZA "subscription-changed" EVENT
  useEffect(() => {
    if (!majstorId) return

    const handleSubscriptionChanged = (event) => {
      console.log('🔔 subscription-changed event received in useSubscription hook!')
      console.log('Event detail:', event.detail)
      
      // Očisti cache i forsiraj refresh
