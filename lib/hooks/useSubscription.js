 ...
 * FIXED: Automatski trial-to-freemium transition
 */
...
// 🔥 NEW: Database function for automatic trial cleanup (optional)
...
export async function createTrialSubscription(majstorId, planName = 'basic') {
  try {
    // Get plan ID
