...
export const ALL_QUICK_ITEMS = [
  ...
  { key: 'team', name: 'Team', icon: '👷', href: '/dashboard/team', feature: 'team', protected: true },
  { key: 'feed', name: 'Team Feed', icon: '📡', href: '/dashboard/team/feed', feature: 'team', protected: true },
  { key: 'aufgaben', name: 'Offene Aufträge', icon: '📋', href: '/dashboard/team/aufgaben', feature: 'team', protected: true },
  { key: 'berichte', name: 'Erledigte', icon: '📝', href: '/dashboard/team/berichte', feature: 'team', protected: true },
  ...
  { key: 'hilfe', name: 'FAQ & Hilfe', icon: '📚', href: '/dashboard/help', protected: false },
]
