...
export const FASTSPRING_CONFIG = {
  storeId: process.env.NEXT_PUBLIC_FASTSPRING_STORE_ID || 'promeister',
  popupUrl: process.env.NEXT_PUBLIC_FASTSPRING_POPUP_URL || 'https://promeister.test.onfastspring.com/popup/promeister',
