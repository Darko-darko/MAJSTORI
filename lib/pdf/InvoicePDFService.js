...
import { PDFA3Service } from './PDFA3Service.js'
...
this.doc.text(
  ...
  async generateInvoice(invoiceData, majstorData) {
    ...
    try {
      ...
      // Inject PDF/A-3b compliance metadata (XMP, OutputIntent + ICC, AF catalog entry)
      // TODO: re-enable after fixing PDFA3Service ICC stream compatibility
      // if (zugferdXML) {
      //   PDFA3Service.inject(this.doc, normalized, majstorData, zugferdFilespec)
      // }
