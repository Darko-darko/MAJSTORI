...
this.doc.text(
  ...
  async addAufmassPositions() {
    ...
    for (let pi = 0; pi < positions.length; pi++) {
      ...
      await this.checkSpaceAndAddPageIfNeeded(180)
      ...
      if (pos.preset === 'mehrteilig' && pos.segments?.length > 0) {
        ...
        const dimRightEdge = sketchX + sketchW + 6 + (dimColsR - 1) * colSp + 12
      ...
      const dimRightEdgeStd = sketchX + sketchW + 6 + (heightDimCols - 1) * colSpH + 12
