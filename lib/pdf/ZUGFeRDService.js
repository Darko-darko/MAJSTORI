// lib/pdf/ZUGFeRDService.js - ZUGFeRD 2.1 EN16931 (COMFORT) - WITH WEG SUPPORT
...
<rsm:CrossIndustryInvoice xmlns:ram="urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100" 
  ...
  static buildApplicableHeaderTradeSettlement(invoice, majstor) {
    ...
    const effectiveTaxAmount = totalAmount - subtotal
    
    // Determine VAT rate - use actual rate from majstor if present
    let effectiveVatRate = this.parseNumber(majstor.vat_rate, 0)
