  ...
  if (aufmass.gewerk === 'fensterbau') {
    ...
    for (let pi = 0; pi < positions.length; pi++) {
      ...
      if (totalPosH > 0) {
        ...
        // Extension lines
        doc.line(sketchX - 1, sketchY, dimX - 1.5, sketchY)
        doc.line(sketchX - 1, sketchY + sketchH, dimX - 1.5, sketchY + sketchH)
        // Dimension line
        doc.line(dimX, sketchY, dimX, sketchY + sketchH)
        // Ticks
        doc.line(dimX - 1, sketchY, dimX + 1, sketchY)
        doc.line(dimX - 1, sketchY + sketchH, dimX + 1, sketchY + sketchH)
        // Text (rotated, centered vertically)
        doc.text(`${totalPosH}`, dimX - 3, sketchY + sketchH / 2, { align: 'center', angle: 90 })
      }
