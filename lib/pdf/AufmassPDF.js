...
function drawFloorSketchOnly(doc, room, margin, startY, contentW, gewerk) {
  ...
  doc.setFontSize(7)
  doc.setTextColor(40)
  doc.text(fmtDim(L), fx + rectW / 2, fy + rectH + bottomDim - 3, { align: 'center' })
  doc.text(fmtDim(B), fx - leftDim + 5, fy + rectH / 2, { align: 'center', angle: 90 })

  return fy + rectH + bottomDim + 5
}
