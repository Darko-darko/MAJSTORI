...
- **🎁 7 Tage alle PRO-Funktionen gratis nach Registrierung!**
- Danach kostenlos für immer, ohne Kreditkarte

### 💎 PRO - 19,90€/Monat (+ MwSt.)
- Alles aus Freemium
- Kundenverwaltung, Rechnungen & Angebote (ZUGFeRD)
- PDF-Archiv, Statistiken, Mahnungen
- KI-Sprachdiktat, Regiebericht
- Buchhalter-Zugang & Ausgaben-Tracking
- **30 Tage kostenlos testen**

### 🚀 PRO+ - 29,90€/Monat (+ MwSt.)
- Alles aus PRO
- Team-Kommunikation (Aufgaben, Nachrichten, Broadcast)
- Digitales Aufmaß mit PDF & Angebot-Übernahme
- Mitarbeiterverwaltung & Zeiterfassung
- 2 Mitarbeiter inklusive, weitere je 8€/Monat
- **30 Tage kostenlos testen**`,
          tags: ['preise', 'kosten', 'freemium', 'pro', 'pro+', 'team'],
          category: 'grundlagen'
        },
        {
...
✅ Basis-Profil & Dashboard
🎁 **7 Tage alle PRO-Funktionen gratis** nach Registrierung — ohne Kreditkarte!

**Nach 7 Tagen nur PRO (19,90€/Monat):**
❌ Kundenverwaltung & Rechnungen/Angebote
❌ PDF-Archiv, Mahnungen, Statistiken
❌ KI-Sprachdiktat & Regiebericht
❌ Buchhalter-Zugang & Ausgaben

**Nur PRO+ (29,90€/Monat):**
❌ Team-Kommunikation & Aufgaben
❌ Digitales Aufmaß
❌ Mitarbeiterverwaltung & Zeiterfassung`,
          tags: ['freemium', 'kostenlos', 'funktionen', 'pro', 'pro+', '7 tage'],
          category: 'grundlagen'
        },
        {
          id: 'probezeitraum',
          question: 'Gibt es einen Testzeitraum für PRO?',
          answer: `**Zwei Möglichkeiten zum Testen:**

### 🎁 7 Tage gratis (automatisch)
- Nach Registrierung sofort alle PRO-Funktionen
- **Keine Kreditkarte nötig!**
- Endet automatisch → Freemium

### 💎 30 Tage PRO/PRO+ Probezeitraum
- Kreditkarte erforderlich (FastSpring)
- **Keine Abbuchung** während der 30 Tage
- Jederzeit kündbar → keine Kosten
- Nach 30 Tagen: automatische Verlängerung oder Wechsel zu Freemium

**Risikofrei testen!**`,
          tags: ['testzeitraum', 'trial', 'pro', '7 tage', 'gratis'],
          category: 'grundlagen'
        },
        {
          id: 'kuendigung',
...
✅ KI-Assistent für App-Fragen ebenfalls inklusive`,
    ...
    {
      id: 'pro-features',
      title: 'PRO & PRO+ Funktionen',
      icon: '💎',
      description: 'Regiebericht, Buchhalter, Team, Aufmaß',
      anchor: '#pro-features',
      questions: [
        {
          id: 'was-ist-regiebericht',
          question: 'Was ist ein Regiebericht?',
          answer: `**Arbeitsnachweis mit Unterschrift:**

Ein Regiebericht dokumentiert durchgeführte Arbeiten — ideal für Hausverwaltungen und WEG.

**Enthält:**
✅ Datum & Uhrzeit
✅ Leistungsort (aus Rechnung übernommen)
✅ Durchgeführte Arbeiten (aus Positionen übernommen)
✅ Mieter-/Bewohnername & Wohnungsnummer
✅ **Digitale Unterschrift** des Mieters

**So geht's:**
1️⃣ Neue Rechnung erstellen
2️⃣ Unten "Regiebericht erstellen" klicken
3️⃣ Mieter unterschreibt auf dem Handy
4️⃣ PDF wird automatisch als Anhang zur Rechnung hinzugefügt
5️⃣ Beim E-Mail-Versand wird der Regiebericht automatisch mitgeschickt

**Tipp: Direkt beim Kunden vor Ort ausfüllen lassen!**

⚠️ Nur im PRO-Plan`,
          tags: ['regiebericht', 'unterschrift', 'weg', 'hausverwaltung', 'nachweis'],
          category: 'pro-features'
        },
        {
          id: 'was-ist-buchhalter-zugang',
          question: 'Wie funktioniert der Buchhalter-Zugang?',
          answer: `**Ihr Buchhalter bekommt eigenen Login:**

**Einrichten:**
1️⃣ Dashboard → Buchhalter → "Portal-Zugang aktivieren"
2️⃣ E-Mail-Adresse des Buchhalters eingeben
3️⃣ Buchhalter erhält Einladung per E-Mail

**Was der Buchhalter sieht:**
✅ Dashboard mit Statistiken (Rechnungen, Umsatz, Überfällig)
✅ Alle Rechnungen nach Monat sortiert
✅ Alle Ausgaben/Belege nach Monat sortiert
✅ ZIP-Download für jeden Monat
✅ Rechnungen als "bezahlt" markieren

**Alternativ — Massenversand per E-Mail:**
📧 Buchhalter → Zeitraum wählen → alle auswählen → "An Buchhalter senden"

**Tipp:** Portal-Zugang spart Zeit — der Buchhalter holt sich alles selbst!

⚠️ Nur im PRO-Plan`,
          tags: ['buchhalter', 'portal', 'zugang', 'steuerberater', 'export'],
          category: 'pro-features'
        },
        {
          id: 'was-ist-ausgaben',
          question: 'Was ist die Ausgaben-Funktion?',
          answer: `**Belege & Quittungen digital erfassen:**

✅ Fotos von Kassenbons, Tankquittungen, Materialkosten
✅ Automatisch komprimiert und gespeichert
✅ Nach Monat gruppiert anzeigbar
✅ Als ZIP gesammelt an Buchhalter senden

**So geht's:**
1️⃣ Dashboard → Ausgaben
2️⃣ Beleg fotografieren oder hochladen
3️⃣ Fertig — wird automatisch archiviert

**Versand an Buchhalter:**
📧 Buchhalter → Tab "Ausgaben" → Zeitraum → "An Buchhalter senden"

⚠️ Nur im PRO-Plan`,
          tags: ['ausgaben', 'belege', 'quittungen', 'kosten', 'buchhalter'],
          category: 'pro-features'
        },
        {
          id: 'was-ist-team',
          question: 'Wie funktioniert die Team-Kommunikation (PRO+)?',
          answer: `**Kommunikation mit Ihren Mitarbeitern:**

### Aufgaben
✅ Aufgabe erstellen → Mitarbeiter zuweisen
✅ Titel, Beschreibung, Fälligkeitsdatum
✅ Mitarbeiter sieht Aufgabe in seinem Dashboard

### Nachrichten
✅ Direkte Konversation mit jedem Mitarbeiter
✅ Text und Fotos senden (Kamera oder Galerie)
✅ Lesebestätigungen (✓✓)

### Broadcast
✅ Nachricht an alle Mitarbeiter gleichzeitig
✅ Mitarbeiter bestätigen mit 👍
✅ Ideal für Ankündigungen

### Mitarbeiter einladen
1️⃣ Team → "Mitarbeiter einladen"
2️⃣ E-Mail eingeben → Einladung wird gesendet
3️⃣ Mitarbeiter erstellt eigenen Login

**Kosten:** 2 Mitarbeiter inklusive, weitere je 8€/Monat

⚠️ Nur im PRO+-Plan`,
          tags: ['team', 'mitarbeiter', 'kommunikation', 'aufgaben', 'nachrichten', 'broadcast', 'pro+'],
          category: 'pro-features'
        },
        {
          id: 'was-ist-aufmass',
          question: 'Was ist das digitale Aufmaß (PRO+)?',
          answer: `**Maße direkt auf der Baustelle erfassen:**

### Bereiche & Positionen
✅ Beliebig viele Bereiche (Räume/Zonen)
✅ Einheiten: m², lfm, m³, Stk, Wand, Trapez
✅ Abzüge für Öffnungen (Türen, Fenster)
✅ Ergänzungen (Erker, Nischen)
✅ Automatische Netto-Berechnung

### Materialien
✅ Benötigte Materialien pro Aufmaß erfassen
✅ Einheiten: Stk, L, kg, m, m², Karton, Sack

### PDF
✅ Professionelles PDF mit Skizzen und Maßangaben
✅ Zusammenfassung aller Bereiche
✅ Materialien-Tabelle
✅ Digitale Unterschrift des Kunden

### In Angebot übernehmen
✅ 1-Klick: alle Positionen + Materialien ins Angebot
✅ Preise dann im Angebot ergänzen

**Tipp:** Aufmaß vor Ort erstellen, unterschreiben lassen, direkt Angebot erstellen!

⚠️ Nur im PRO+-Plan`,
          tags: ['aufmaß', 'aufmass', 'maße', 'baustelle', 'fläche', 'positionen', 'pro+'],
          category: 'pro-features'
        },
        {
          id: 'mitarbeiter-kosten',
          question: 'Was kostet ein zusätzlicher Mitarbeiter?',
          answer: `**PRO+ Mitarbeiter-Preise:**

✅ **2 Mitarbeiter inklusive** im PRO+-Plan (29,90€/Monat)
✅ Jeder weitere Mitarbeiter: **8€/Monat** (+ MwSt.)

**Beispiel:**
- 2 Mitarbeiter: 29,90€/Monat (keine Zusatzkosten)
- 3 Mitarbeiter: 29,90€ + 8€ = 37,90€/Monat
- 5 Mitarbeiter: 29,90€ + 3×8€ = 53,90€/Monat

**Mitarbeiter können:**
✅ Aufgaben sehen und bearbeiten
✅ Nachrichten mit dem Chef austauschen
✅ Fotos von der Baustelle senden
✅ Arbeitszeit per Timer erfassen

⚠️ Nur im PRO+-Plan`,
          tags: ['mitarbeiter', 'kosten', 'seats', 'team', 'pro+', 'preis'],
          category: 'pro-features'
        }
      ]
    },
...
**📈 Upgrade:**
- Freemium → PRO oder PRO+
- PRO → PRO+
- Sofortiger Zugriff, Zahlung über FastSpring

**📉 Downgrade:**
- PRO+ → PRO (Team-Funktionen entfallen)
- PRO → Freemium (Kündigung, 30 Tage Frist)
- PDF-Archiv bleibt immer erhalten!

**🔄 Reaktivierung:**
- Jederzeit PRO/PRO+ aktivieren
- Alle Daten bleiben
- Nummerierung setzt fort

**Kein Datenverlust!**`,
          tags: ['wechsel', 'upgrade', 'downgrade', 'pro+'],
          category: 'abonnement'
        },
        {
          id: 'rechnung-firma',
...
**Ihr Feedback formt die Plattform!**`,
  ...
  popularQuestions: [
    ...
    'was-ist-team',
    'was-ist-aufmass',
    'was-ist-regiebericht',
    'was-ist-buchhalter-zugang',
    'support-kontakt'
  ],
