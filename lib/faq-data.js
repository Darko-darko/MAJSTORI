...
**Wir haben eine transparente Richtlinie - keine Komplikationen bei der Kündigung!**`,
        ...
        {
          id: 'sprachen',
          question: 'In welchen Sprachen ist die Plattform verfügbar?',
          answer: `Die Plattform ist derzeit in **zwei Sprachen** verfügbar:

🇩🇪 **Deutsch** - Hauptsprache
- Gesamte Benutzeroberfläche auf Deutsch
- Rechnungen und Angebote nach deutschen Standards (DIN 5008)
- Angepasst an den deutschen Markt und Vorschriften
- Unterstützung für GDPR/DSGVO-Standards

🇷🇸 **Serbisch** - FAQ und Support
- FAQ-Bereich auf Serbisch verfügbar
- Support auf Serbisch
- Erleichtertes Onboarding für serbischsprachige Nutzer

📋 **Dokumente:**
- Rechnungen und Angebote werden auf **Deutsch** erstellt
- In Übereinstimmung mit deutschen Geschäftsstandards
- Professionelles Erscheinungsbild nach DIN-Normen

**Der Fokus liegt auf dem deutschen Markt, mit Unterstützung für serbischsprachige Handwerker.**`,
          tags: ['sprachen', 'deutsch', 'serbisch', 'mehrsprachig'],
          category: 'grundlagen'
        }
      ]
    },
